...
I'm The Dogfather a modified version of Group Butler 
...
To work properly, [it needs to be admin in your group](104), so it can kick or ban people if needed.
Only the group owner can promote it :)

You can use `/, ! or #` to trigger a command.

Dogfather saves the adminlist of a group in its databse to avoid to send too many requests to Telegram.
...
(you can find a video-tutorial [here](s/8))
